...
Analyze this codebase deeply and create `.claude/commands/validate-2.md` that comprehensively validates everything.
...
## Step 2: Generate validate-2.md

Create `.claude/commands/validate-2.md` with these phases (ONLY include phases that exist in the codebase):
...
Write the generated validation command to `.claude/commands/validate-2.md`
